...
##THIS LINE BELOW CHANGE THE SHA256 CHECKSUM in the VAR ran to build the machine##
sed -i "s/\"sha256:.*\"/\"sha256:$sha_win10\"/g" windows_10_cloudinit.pkvars.hcl
...
##THIS LINE BELOW CHANGE THE SHA256 CHECKSUM in the VAR ran to build the machine##
sed -i "s/\"sha256:.*\"/\"sha256:$sha_win10\"/g" windows_10_cloudinit_uptodate.pkvars.hcl
...
##THIS LINE BELOW CHANGE THE SHA256 CHECKSUM in the VAR ran to build the machine##
sed -i "s/\"sha256:.*\"/\"sha256:$sha_winserv2016\"/g" windows_server2016.pkvars.hcl
...
##THIS LINE BELOW CHANGE THE SHA256 CHECKSUM in the VAR ran to build the machine##
sed -i "s/\"sha256:.*\"/\"sha256:$sha_winserv2019\"/g" windows_server2019.pkvars.hcl
