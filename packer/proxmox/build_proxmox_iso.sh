...
mkisofs -J -l -R -V "autounatend CD" -iso-level 4 -o ./iso/Autounattend_windows10_cloudinit.iso Windows-10/answer_files/10_proxmox_cloudinit
...
mkisofs -J -l -R -V "autounatend CD" -iso-level 4 -o ./iso/Autounattend_windows10_cloudinit_uptodate.iso Windows-10/answer_files/10_proxmox_cloudinit_uptodate
...
mkisofs -J -l -R -V "autounatend CD" -iso-level 4 -o ./iso/Autounattend_winserver2016_cloudinit.iso Windows-Server-2016/answer_files/2016_proxmox_cloudinit
...
mkisofs -J -l -R -V "autounatend CD" -iso-level 4 -o ./iso/Autounattend_winserver2019_cloudinit.iso Windows-Server-2019/answer_files/2019_proxmox_cloudinit
...
mkisofs -J -l -R -V "autounatend CD" -iso-level 4 -o ./iso/Autounattend_winserver2019_cloudinit_uptodate.iso Windows-Server-2019/answer_files/2019_proxmox_cloudinit_uptodate
